URL: https://alfapiter.ru/assets/template/js/phoneinput.js
CT: text/javascript
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var onLoadPage = function (input) { // проверяем пустое ли поле телефона при загрузке страницы
        if(input.value) {
